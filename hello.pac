// you know
/*
domains:表示国外网站的域名库，基本包含了你知道的所有国外需要科学上网的域名
*/
var domains = {
  "ggpht.com":1,
  "gimpshop.com": 1, 
...
/*
使用shadowsocks qt5 科学上网包含三种方式
1 SOCKS5
2 SOCKS
3 DIRECT
其中第三种就是直接访问，一般上国内的网站就使用DIRECT
*/
 ...
 * 
 * @param url 你访问的url
 * @param host 你访问网站的域名(比如www.google.com host就是google.com)
 * 当你访问网站时候，会根据你访问的网址自动筛选，如果是国外的网站则使用代理，否则还是用本地的ip去访问
 * 
 */
function FindProxyForURL(url, host) {
    ...
    do {
        ...
        //依次得到每个点后面的字符串，比如123.456.789.com
        //先获取456.789.com
        //然后789.com , 直到没有.
        //一直找到最后一个点，如果还没有发现有相同的域名则返回direct
